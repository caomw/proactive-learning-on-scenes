...
int main(int argc, char** argv) {
	...
	try {
		...
		DXUTInit( true, true );					// Parse the command line, show msg boxes on error, and an extra cmd line param to force REF for now
...
void StopScanningAndDumpVoxelHash() {//wei
